...

{
    ...
    printf("\nEnter the age:");
    scanf("%d",&add.age);
    printf("\nEnter the address(without spaces):");
    scanf("%s",add.address);
    printf("\nEnter the citizenship(without spaces) :");
    scanf("%s",add.citizenship);
    printf("\nEnter the phone number: ");
    scanf("%lf",&add.phone);
    printf("\nEnter the amount to deposit:$");
    scanf("%f",&add.amt);
    printf("\nType of account:\n\t#Saving\n\t#Current\n\t#Fixed1(for 1 year)\n\t#Fixed2(for 2 years)\n\t#Fixed3(for 3 years)\n\n\tEnter your choice(Name of the account):");
...
void close(void)
{
    printf("\n\n\n\nThis C Mini Project is developed by me!");
    }
